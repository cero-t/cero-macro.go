...
<input type="submit" id="record_1" name="record" value="Record (1P)" onclick="return sendName(this, 'player1');"/>
<input type="submit" id="play_1" name="play" value="Play (1P)" onclick="return sendName(this, 'player1');"/>
&nbsp;
<input type="submit" id="record_2" name="record" value="Record (2P)" onclick="return sendName(this, 'player2');"/>
<input type="submit" id="play_2" name="play" value="Play (2P)" onclick="return sendName(this, 'player2');"/>
<br/>
<br/>
<br/>
...
<div>
	...
	<div class="commands">
		...
		<div>
			<button id="start_1" value="start" class="commandButton" onclick="return send(this, 'player1');">Start</button>
			<button id="back_1" value="back" class="commandButton" onclick="return send(this, 'player1');">Back</button>
			<button id="left_1" value="lb" class="directionButton" onclick="return send(this, 'player1');">&lt;&lt;</button>
			<button id="right_1" value="hp" class="directionButton" onclick="return send(this, 'player1');">&gt;&gt;</button>
		</div>
	</div>
...
<div>
	...
	<div class="commands">
		...
		<div>
			<button id="start_2" value="start" class="commandButton" onclick="return send(this, 'player2');">Start</button>
			<button id="back_2" value="back" class="commandButton" onclick="return send(this, 'player2');">Back</button>
			<button id="left_2" value="lb" class="directionButton" onclick="return send(this, 'player2');">&lt;&lt;</button>
			<button id="right_2" value="hp" class="directionButton" onclick="return send(this, 'player2');">&gt;&gt;</button>
		</div>
	</div>
	<div style="clear: both;"></div>
</div>
