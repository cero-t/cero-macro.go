...
func PushStart(vjoyId uint) bool {
	return push(vjoyId, 10)
}

func ReleaseStart(vjoyId uint) bool {
	return release(vjoyId, 10)
}

func PushBack(vjoyId uint) bool {
	return push(vjoyId, 9)
}

func ReleaseBack(vjoyId uint) bool {
	return release(vjoyId, 9)
}

func PushRecord(vjoyId uint) bool {
	return push(vjoyId, 11)
}

func ReleaseRecord(vjoyId uint) bool {
	return release(vjoyId, 11)
}

func PushPlay(vjoyId uint) bool {
	return push(vjoyId, 12)
}

func ReleasePlay(vjoyId uint) bool {
	return release(vjoyId, 12)
}

func PushLb(vjoyId uint) bool {
	return push(vjoyId, 5)
}

func ReleaseLb(vjoyId uint) bool {
	return release(vjoyId, 5)
}

func PushLt(vjoyId uint) bool {
	return push(vjoyId, 7)
}

func ReleaseLt(vjoyId uint) bool {
	return release(vjoyId, 7)
}
